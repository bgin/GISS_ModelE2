qflux_AIE.R GISS Model E  1850 ocn/atm          Larissa     07/15/2014

qflux_AIE is for q-flux simulations based upon AR5 configuration; includes AIE 
                 U00a=0.567, U00b=1.0, WMUI_multiplier=1.; 
...
![eml Add netcdf IO 
#define NEW_IO_AIC
!#define NEW_IO_OCNINP
!#define NEW_IO_GLMELT
!#define NEW_IO_VEG
#define NEW_IO_TOPO
#define NEW_IO_RVR
!#define NEW_IO_ZVAR
!#define NEW_IO_SOILCARB
!eml]
...
OPTS_dd2d = NC_IO=NETCDF ! CHANGE TO NETCDF eml 

Data input files:
#include "IC_144x90_input_files_nc_eml" /*[eml add AIC nc eml]*/
#include "static_ocn_2000_144x90_input_files_eml_lshen"

RVR=RD_Fb.nc!RVR.bin          ! river direction file
NAMERVR=RD_Fb.names.txt
...
E_AR5_V2_NINT (E_AR5_NINT + U00a=0.567; U00b=1.0; CMTN=0.1; CDEF=1.6) 
...
U00a=0.567      ! above 850mb w/o MC region; tune this first to get 30-35% high clouds
...
#include "atmCompos_2000_params_AIE"
...
&&END_PARAMETERS
 ...
 ISTART=2,IRANDI=0, YEARE=1949,MONTHE=12,DATEE=2,HOURE=0,
