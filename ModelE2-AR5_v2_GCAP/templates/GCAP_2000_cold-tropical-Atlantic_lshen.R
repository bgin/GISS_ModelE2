GCAP.R GISS Model E  1850 ocn/atm          Larissa     07/15/2014

GCAP is for AR5 Prime production runs; 
...
#include "static_ocn_2000_144x90_cold-tropical-Atlantic_lshen_input_files_eml"
